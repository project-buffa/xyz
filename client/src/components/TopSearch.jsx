    ...
    return (
      <div className='topsearch'>
        <ul>
            ...
            <li style={activeTopSearchStyle}><Link><Input transparent icon='search' placeholder='Search...' value={this.props.dress} onChange={this.handleSearchDressChange} /></Link></li>
        </ul>
      </div>
    )
  }
